        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 26, "Semi-Flush Backbox for Series 1000 Annunciators  (Houses 2 Modules) \r\nStainless Steel Finish (18”H x 12.75”W x 1.85”D)\r\nMounts over standard electrical box by others", 5, "BB-1002DS", "C", 590.0, 1 },
                    { 27, "Weather Protected Backbox for Series 1000 Annunciators (Houses 2 Module)\r\n   Dimensions: (11-11/32\" Height, 13\" Width, 3.5\" Depth)\r\n   Rated for Outdoor Environment: +50°C to -40°C - 95% R.H. @60°C\r\n   Lexan sealed window, to protect against the challenges of an outdoor application\r\n   Surface mount application. RED Door.\r\n   NOTE: there is no need for thermostat or heater. RAM-1032TZDS-CC and RAX-1048TZDS-CC must be ordered separately to match UL, ULC installation requirements.", 5, "BB-1002WPRA", "B", 1335.0, 1 },
                    { 28, "Weather Protected Backbox for Series 1000 Annunciators (Houses 2 Module)\r\n   Dimensions: (11-11/32\" Height, 13\" Width, 3.5\" Depth)\r\n   Rated for Outdoor Environment: +50°C to -40°C - 95% R.H. @60°C\r\n   Lexan sealed window, to protect against the challenges of an outdoor application\r\n   Surface mount application. WHITE Door.\r\n   NOTE: there is no need for thermostat or heater. RAM-1032TZDS-CC and RAX-1048TZDS-CC must be ordered separately to match UL, ULC installation requirements.", 5, "BB-1002WPA", "C", 1335.0, 1 },
                    { 29, "Semi-Flush Backbox for Series 1000 Annunciators  (Houses 3 Modules)\r\nRED Door & Black Backbox (12.75\"W X 26.4\"L X 1.85\"D) without door\r\nMounts over standard electrical box by others", 5, "BB-1003DR", "C", 640.0, 1 },
                    { 30, "Semi-Flush Backbox for Series 1000 Annunciators  (Houses 3 Modules)\r\nWHITE Door & Black Backbox (12.75\"W X 26.4\"L X 1.85\"D) without door\r\nMounts over standard electrical box by others", 5, "BB-1003D", "B", 640.0, 1 },
                    ...
                    { 39, "4000 Series Photoelectric Detector W/O Isolation", 6, "MIX-4010", "A", 130.0, 1 },
                    { 40, "4000 Series Photoelectric Detector with Isolation", 6, "MIX-4010-ISO", "A", 140.0, 1 },
                    { 41, "4000 Series Multi Sensor - Photoelectric heat W/O Isolation", 6, "MIX-4020", "A", 160.0, 1 },
                    { 42, "4000 Series Multi Sensor - Photoelectric heat with Isolation", 6, "MIX-4020-ISO", "B", 170.0, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 43, "4000 Series Tri-Mode Heat Detector W/O Isolation", 6, "MIX-4030", "A", 110.0, 1 },
                    { 44, "4000 Series Tri-Mode Heat Detector with Isolation", 6, "MIX-4030-ISO", "A", 120.0, 1 },
                    { 45, "4000 Series 6\" Detector Base", 6, "MIX-4001", "A", 28.0, 1 },
                    { 46, "4000 Series 4\" Detector Base", 6, "MIX-4002", "A", 24.0, 1 },
                    { 47, "4000 Series Relay Base", 6, "MIX-4003-R", "B", 140.0, 1 },
                    { 48, "4000 Series Sounder Base", 6, "MIX-4003-S", "B", 1275.0, 1 },
                    { 49, "4000 Series Addressable Device Programmer", 6, "MIX-4090", "A", 600.0, 1 },
                    { 50, "4000 Series Dual Input Module", 6, "MIX-4040", "A", 130.0, 1 },
                    { 51, "4000 Series Mini Dual Input Module", 6, "MIX-4041", "A", 110.0, 1 },
                    { 52, "4000 Series Conventional Zone Module", 6, "MIX-4042", "B", 195.0, 1 },
                    { 53, "4000 Series Dual Relay Module", 6, "MIX-4045", "A", 150.0, 1 },
                    { 54, "4000 Series Supervised Output Module", 6, "MIX-4046", "A", 160.0, 1 },
                    { 55, "Sync Module", 6, "MIX-4050", "A", 170.0, 1 },
                    { 56, "4000 Series Isolator Module", 6, "MIX-4070", "A", 115.0, 1 },
                    { 57, "MP 1 STAGE ADDR DOUBLE ACTION PULL STATION ULC", 7, "MPS-810MP", "N", 190.0, 1 },
