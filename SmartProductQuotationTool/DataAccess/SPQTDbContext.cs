    ...
    public class SPQTDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Inventory>().HasData(
                new Inventory() { InventoryId = 1, Level = 1, Name = "FX-401R", Description = "Intelligent Fire Alarm Control Unit c/w 1 Intelligent Loop compatible with MGC Devices 4000 Series only)\r\n \tExpandable to three SLCs with the addition of the Dual Loop Controller ALC-480.\r\n \t1  20 Character  by 4 Line  Back-Lit LCD Display\r\n \t4  Class A/B (Style Z/Y) NAC Circuits\r\n \tFour Event Display Queues\r\n \tc/w UB-1024DS Universal Backbox & DOX-1024DSR RED Door\r\n \tSpace for 2 RAX-1048TZDS LED Annunciator Modules\r\n* Standard RED Door", Price = 3600.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 2, Level = 1, Name = "FX-401B", Description = "Intelligent Fire Alarm Control Unit c/w 1 Intelligent Loop compatible with MGC Devices 4000 Series only)\r\n \tExpandable to three SLCs with the addition of the Dual Loop Controller ALC-480.\r\n \t1  20 Character  by 4 Line  Back-Lit LCD Display\r\n \t4  Class A/B (Style Z/Y) NAC Circuits\r\n \tFour Event Display Queues\r\n \tc/w UB-1024DS Universal Backbox & DOX-1024DSR RED Door\r\n \tSpace for 2 RAX-1048TZDS LED Annunciator Modules\r\n* Standard BLACK Door", Price = 3600.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 3, Level = 2, Name = "RAX-LCD-LITE", Description = "Remote LCD Annunciator, MIMIC Display for FX-400, FX-401, FX-3318, FX-3500 c/w Large 4 x 20 Character Back-Lit LCD Display, Four Event Display Queues. Common Controls, Mounts in BB-1000 Series Enclosure", Price = 1400.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 4, Level = 2, Name = "RAM-1032TZDS", Description = "Main Annunciator Chassis  c/w 32 Bi-colored LEDs, 32 Zoned Trouble LEDs\r\nCommon Indicators --\r\nAC On, Common Trouble, Auxiliary Disconnect,\r\n2 Stage Acknowledge & General Alarm Activate (if Config.)\r\nCommon Controls --\r\nReset, Lamp Test,  Fire Drill, Auxiliary Disconnect, \r\nLocal Buzzer & Signal Silence. Mounts in BB-1000 Series Enclosure", Price = 825.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 5, Level = 2, Name = "RAM-1032TZDS-CC", Description = "Main Annunciator Chassis  c/w 32 Bi-colored LEDs, 32 Zoned Trouble LEDs\r\nCommon Indicators -- AC On, Common Trouble, Auxiliary Disconnect,\r\n2 Stage Acknowledge & General Alarm Activate (if Config.)\r\nCommon Controls -- Reset, Lamp Test,  Fire Drill, Auxiliary Disconnect, \r\nLocal Buzzer & Signal Silence\r\nMounts in BB-1000 Series enclosure or BB-5008 or BB-5014", Price = 1120.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 6, Level = 2, Name = "RAX-1048TZDS", Description = "Adder Annunciator Chassis c/w 48 Bi-Coloured LEDs; 48 Zoned Trouble LED's\r\nMounts in BB-1000 Series enclosure", Price = 555.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 7, Level = 2, Name = "RAX-1048TZDS-CC", Description = "Conformal Coated Adder Annunciator Chassis c/w 48 Bi-Coloured LEDs; 48 Zoned Trouble LED's. Mounts in BB-1000 or BB-5000 Series Enclosure.", Price = 830.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 8, Level = 3, Name = "UIMA4", Description = "Interface for Configuring FleXNet™, FA-300 Series, FX-2000 Series, FX-401, FX-3500, QX-5000, UDACT-300, and MR-2300 Series", Price = 295.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 9, Level = 3, Name = "MGC-CONFIG-KIT4", Description = "Fire Panel Configuration Kit4 With UIMA4", Price = 425.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 10, Level = 4, Name = "ALC-480", Description = "FX-401 Dual Loop Controller Module 480 points (MGC Devices 4000 Series Compatible)", Price = 1160.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 11, Level = 4, Name = "PR-300", Description = "Polarity Reversal & City Tie c/w Alarm, Supervisory & Trouble Transmit Capabilities", Price = 255.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 12, Level = 4, Name = "AGD-048", Description = "Adder Graphic Driver Board, c/w 48 Supervised Outputs, Output Connections via Terminals or Ribbon Cable\r\nMounts in Graphic Wall box", Price = 815.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 13, Level = 4, Name = "MGD-32", Description = "Master Graphic Driver Board c/w, Fire Alarm Common Control Switch Inputs & LED Outputs\r\n32 Supervised Outputs, Output Connections via Terminals or Ribbon Cable\r\nMounts in Graphic Wall box", Price = 1105.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 14, Level = 4, Name = "PCS-100", Description = "Power Supply Interface Board", Price = 210.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 15, Level = 4, Name = "MP-3500W", Description = "Solenoid End of Line Resistor 47K, White Plate", Price = 35.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 16, Level = 4, Name = "SRM-312R", Description = "SMART Relay Module with Enclosure (12) RED", Price = 780.00, PVCode = "C", Qty = 1 },
                new Inventory() { InventoryId = 17, Level = 5, Name = "BB-1001DR", Description = "Semi-Flush Backbox for Series 1000 Annunciators (Houses 1 Module)\r\nRED Door & Black Backbox (12.75\"W X 9\"L X 1.85\"D without door)\r\nMounts over standard electrical box by others", Price = 285.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 18, Level = 5, Name = "BB-1001D", Description = "Semi-Flush Backbox for Series 1000 Annunciators (Houses 1 Module)\r\nWHITE Door & Black Backbox (12.75\"W X 9\"L X 1.85\"D without door)\r\nMounts over standard electrical box by others", Price = 285.00, PVCode = "A", Qty = 1 },
                ...
                new Inventory() { InventoryId = 39, Level = 6, Name = "MIX-4010", Description = "4000 Series Photoelectric Detector W/O Isolation", Price = 130.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 40, Level = 6, Name = "MIX-4010-ISO", Description = "4000 Series Photoelectric Detector with Isolation", Price = 140.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 41, Level = 6, Name = "MIX-4020", Description = "4000 Series Multi Sensor - Photoelectric heat W/O Isolation", Price = 160.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 42, Level = 6, Name = "MIX-4020-ISO", Description = "4000 Series Multi Sensor - Photoelectric heat with Isolation", Price = 170.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 43, Level = 6, Name = "MIX-4030", Description = "4000 Series Tri-Mode Heat Detector W/O Isolation", Price = 110.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 44, Level = 6, Name = "MIX-4030-ISO", Description = "4000 Series Tri-Mode Heat Detector with Isolation", Price = 120.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 45, Level = 6, Name = "MIX-4001", Description = "4000 Series 6\" Detector Base", Price = 28.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 46, Level = 6, Name = "MIX-4002", Description = "4000 Series 4\" Detector Base", Price = 24.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 47, Level = 6, Name = "MIX-4003-R", Description = "4000 Series Relay Base", Price = 140.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 48, Level = 6, Name = "MIX-4003-S", Description = "4000 Series Sounder Base", Price = 1275.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 49, Level = 6, Name = "MIX-4090", Description = "4000 Series Addressable Device Programmer", Price = 600.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 50, Level = 6, Name = "MIX-4040", Description = "4000 Series Dual Input Module", Price = 130.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 51, Level = 6, Name = "MIX-4041", Description = "4000 Series Mini Dual Input Module", Price = 110.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 52, Level = 6, Name = "MIX-4042", Description = "4000 Series Conventional Zone Module", Price = 195.00, PVCode = "B", Qty = 1 },
                new Inventory() { InventoryId = 53, Level = 6, Name = "MIX-4045", Description = "4000 Series Dual Relay Module", Price = 150.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 54, Level = 6, Name = "MIX-4046", Description = "4000 Series Supervised Output Module", Price = 160.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 55, Level = 6, Name = "MIX-4050", Description = "Sync Module", Price = 170.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 56, Level = 6, Name = "MIX-4070", Description = "4000 Series Isolator Module", Price = 115.00, PVCode = "A", Qty = 1 },
                new Inventory() { InventoryId = 57, Level = 7, Name = "MPS-810MP", Description = "MP 1 STAGE ADDR DOUBLE ACTION PULL STATION ULC", Price = 190.00, PVCode = "N", Qty = 1 },
                new Inventory() { InventoryId = 58, Level = 7, Name = "MPS-802MP", Description = "MP 2 STAGE ADDRESSABLE PULL STATION ULC", Price = 200.00, PVCode = "N", Qty = 1 },
                new Inventory() { InventoryId = 59, Level = 7, Name = "MPS-822MP", Description = "MP MAGLOCK 2 STAGE ADDR DOUBLE ACTION PULL STATION ULC", Price = 210.00, PVCode = "N", Qty = 1 },
                new Inventory() { InventoryId = 60, Level = 7, Name = "BB-800", Description = "Surface Backbox For 800 Series Manual Station", Price = 45.00, PVCode = "N", Qty = 1 }
            );
        }
    }
}
